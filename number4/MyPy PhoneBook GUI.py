...
from . import MYPYPhoneBook as PhoneBook
...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (MenuPage, GUILookUp, GUIAddEntry):
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.Welcome_Label.grid(column=1, columnspan=3, padx=10, pady=10)

        self.Add_Button = tk.Button(self, text="Add New Entry", command=lambda: controller.show_frame("GUIAddEntry"))
        self.Add_Button.grid(column=1, columnspan=3, padx=10, pady=10)

        self.Delete_Button = tk.Button(self, text="Delete Entry")
        self.Delete_Button.grid(column=1, columnspan=3, padx=10, pady=10)

        self.Update_Button = tk.Button(self, text="Update Entry")
        self.Update_Button.grid(column=1, columnspan=3, padx=10, pady=10)

        self.Lookup_Button = tk.Button(self, text="Lookup Number", command=lambda: controller.show_frame("GUILookUp"))
        self.Lookup_Button.grid(column=1, columnspan=3, padx=10, pady=10)

        self.Exit_Button = tk.Button(self, text="Exit", command=quit)
        self.Exit_Button.grid(column=1, columnspan=3, padx=10, pady=10)
...
class GUIAddEntry(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        button = tk.Button(self, text="Back", command=lambda: controller.show_frame("MenuPage"))
